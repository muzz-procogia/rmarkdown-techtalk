...
--
- In essence, it interweaves narrative with code to create technical documents. We can create HTML and PDF documents with R Markdown using only R code. 

--
- R Markdown is also a way to ensure that the results are reproducible, which is important to guarantee when creating reports.
